...
// function createRandomDeilveries(strategy: string) {
//   console.log("Creating random delivery: "+ strategy);
//   let robot_name = "Robot_" + deliveryID;
//   let start = [randFloat(300, 500), 270, randFloat(-200, 300)];
//   let end = [randFloat(300, 500), 270, randFloat(-200, 300)];
//   sendCommand("CreateEntity", {
//     type: "package",
//     name: robot_name + "_package",
