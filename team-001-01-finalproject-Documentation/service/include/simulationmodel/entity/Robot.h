...
class Robot : public IEntity {
 public:
   ...
   * @param pos_ The new position of the robot as a Vector3 object.
   */
  void setPosition(Vector3 pos_);

  /**
   * @brief Randomly teleports the robot to a new position within predefined bounds.
   */
  ...
  /// @brief Indicates whether the robot is currently requesting a delivery.
